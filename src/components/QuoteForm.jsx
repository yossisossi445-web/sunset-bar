    ...
    <section id="contact" className="container" style={{ margin: '6rem auto' }}>
      <div className="glass-panel" style={{ maxWidth: '600px', margin: '0 auto', padding: '3rem' }}>
        ...
        <form 
          ...
          onSubmit={(e) => {
            e.preventDefault();
            alert("תודה! הפרטים שלך נשלחו בהצלחה וניצור איתך קשר בהקדם.");
          }}
        >
          <div style={{ display: 'flex', gap: '1.5rem' }}>
            <input type="text" placeholder="שם מלא" style={inputStyle} required />
            <input type="tel" placeholder="טלפון" style={inputStyle} required />
          </div>
          <div style={{ display: 'flex', gap: '1.5rem' }}>
